    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Recibimos un pedido para restablecer tu contraseña de <strong>{siteName}</strong>. Hacé clic abajo para elegir una nueva.
          </Text>
          ...
          <Text style={footer}>
            Si no pediste cambiar tu contraseña, podés ignorar este email — tu cuenta sigue segura.
          </Text>
        </Section>
