...
export const MagicLinkEmail = ({ siteName, confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Tu link mágico para {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Hacé clic abajo para iniciar sesión en <strong>{siteName}</strong>. Este link expira pronto.
          </Text>
          ...
          <Text style={footer}>
            Si no pediste este link, podés ignorar este email.
          </Text>
        </Section>
